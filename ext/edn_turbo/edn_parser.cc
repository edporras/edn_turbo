...
#line 837 "edn_parser.rl"

#line 2847 "edn_parser.cc"
	{
	if ( p == pe )
		goto _test_eof;
	switch ( cs )
...
#line 3639 "edn_parser.cc"
	{
	cs = EDN_parser_start;
	}

#line 1077 "edn_parser.rl"
    set_source(src, len);

#line 3647 "edn_parser.cc"
	{
	if ( p == pe )
		goto _test_eof;
	switch ( cs )
...
#line 3768 "edn_parser.cc"
	{
	cs = EDN_tokens_start;
	}

#line 1152 "edn_parser.rl"

#line 3775 "edn_parser.cc"
	{
	if ( p == pe )
		goto _test_eof;
	switch ( cs )
